<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cyber.aspx.cs" Inherits="skills.Application.cyber" %>
...
<head runat="server">
    ...
    <title>Skill - Student Application Cyber Security</title>
                    ...
                    <div class="container">
                        <nav class="navbar navbar-expand-lg navbar-light py-md-2 py-0 px-0">
                            <a class="navbar-brand" href="../index.aspx">
                                <img src="assets/images/logo-icon.png" alt="" />Skill</a>
                ...
                <div class="container">
                    <div class="middle-section">
                        <div class="section-width">
                            <h2>Start your Cyber Security  journey with us today. </h2>
                        </div>
                    ...
                    <div>
                        <div class="main-input">
                            ...
                            <select id="coursetype" name="coursetype" class="contact-input" runat="server">
                                <option value="HDSE" selected="selected">Advanced Diploma in Cyber Security</option>
                                <option value="ADSE">Higher Diploma in Cyber Security</option>
                            </select><br />
                            <br />
                ...
                <div class="container pb-lg-3">
                    <div class="row footer-top-29">
                        <div class="col-lg-4 col-md-6 footer-list-29 footer-1 mt-md-4">
                            <a class="footer-logo mb-md-3 mb-2" href="#url">
                                <img src="assets/images/logo-icon.png" alt="" />Skill</a>
                            <p>
