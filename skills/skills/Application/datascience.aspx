                ...
                <div class="container">
                    <div class="middle-section">
                        <div class="section-width">
                            <h2>Start your Data SCience journey with us today. </h2>
                        </div>
                    ...
                    <div>
                        <div class="main-input">
                            ...
                            <select id="coursetype" name="coursetype" class="contact-input" runat="server">
                                <option value="HDSE" selected="selected">Advanced Diploma in Data Science </option>
                                <option value="ADSE">Higher Diploma in Data Science</option>
                            </select><br />
                            <br />
