...
<head runat="server">
    ...
    <title>Skill - Student Application Muitlmedia</title>
                ...
                <div class="container">
                    <div class="middle-section">
                        <div class="section-width">
                            <h2>Start your Amazing  journey with us today. </h2>
                        </div>
                    ...
                    <div>
                        <div class="main-input">
                            ...
                            <select id="coursetype" name="coursetype" class="contact-input" runat="server">
                                <option value="HDSE" selected="selected">Certificate in MultiMedia</option>
                                <option value="ADSE">Hogher Diploma in Multimedia </option>
                            </select><br />
                            <br />
