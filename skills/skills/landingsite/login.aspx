<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="skills.landingsite.login" %>
...
<head runat="server">
    ...
    <title>Skill - Student Login</title>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item @@contact-active">
								<a class="btn btn-sm btn-outline-danger" href="adminlogin.aspx">Admin</a>
							</li>
...
<section class="w3l-skill-breadcrum">
  <div class="breadcrum">
    <div class="container">
      <p><a href="index.html">Home</a> &nbsp; / &nbsp; Student Login</p>
    </div>
  </div>
</section>
<!-- //breadcrum -->
	...
	<div class="container py-5">
		<div class="contacts12-main py-md-3">
			<div class="header-section text-center">
				<h3 class="mb-md-5 mb-4">Login to access your account
			</div>
			<div >
				...
				<div class="text-right">
                    <asp:Button ID="Button1" class="btn-secondary btn theme-button" runat="server" Text="Login" OnClick="Button1_Click" />
                    <a class="btn-secondary btn theme-button" href="Register.aspx">Register</a>
				</div>
			</div>
		</div>
	</div>
